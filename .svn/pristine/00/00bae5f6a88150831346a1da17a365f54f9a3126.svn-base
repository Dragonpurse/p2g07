...
public class DoosToevoegenDialog extends JDialog{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -1941236663292846724L;
	...
	private JButton doosAanmakenBtn;
	...
	public DoosToevoegenDialog(LeertrajectController controller) {
		super();
	...
	private void initGUI() {
		...
		doosAanmakenBtn = new JButton("Aanmaken");
		doosAanmakenBtn.addActionListener(new Listener());
		contentPanel.add(doosAanmakenBtn,"span, right");
	...
	private class Listener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getSource().equals(doosAanmakenBtn))
				maakDoosAan();
