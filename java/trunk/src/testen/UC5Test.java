...
public class UC5Test {
	...
	public void before(){
		...
		medewerkerMap.put("test", new Medewerker("test", true));
	...
	public void testAanmakenCasus() {
		...
		Assert.assertEquals("antwoord2", ((CasusAntwoord)((Casus)leertrajectController.getManager().geefOnderdeel(0)).getCasusRoot().getChildAt(1)).getAntwoord());
