...
public class UC2Test {
	...
	private Onderdeel doc1 = new Document("TestDoc1", "Dit is een test document", tags, "2TIN", "C:/Users/Test/document1.docx",today,oneYearFromNow);
	private Onderdeel doc2 = new Document("TestDoc2", "Dit is een tweede test document", tags, "3TIN", "C:/Users/Test/document2.docx",threeDaysFromNow,oneYearFromNow);
	
	@Before
	public void before(){
		lc = new LeertrajectController("admin");
	}
	...
	public void testAanmakenLeertrajectVerkeerdeTitel() {
		lc.aanmakenLeertraject("G001", "µ", "DIT\nIS\nEEN\nOMSCHR", threeDaysFromNow, 
